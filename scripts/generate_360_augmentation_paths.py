...
def generate_augment_path(
    sub_dir: str, name: str, subject_id, vert_id, augment_angle, output_path_template, config
):
...
def get_individual_fullpaths_aug(
    ...
    centroid_path = (
        Path(subject_basepath) / subject_id / input_fileformat["ctd"].format(id=subject_id)
    )
